...
echo "    cd $DEST && uv run server.py --details templates/classic/details.personal.yml"
echo ""
echo "  Option B — CLI watch mode:"
echo "    cd $DEST && uv run templates/classic/build.py --watch --details templates/classic/details.personal.yml"
echo ""
echo "  Edits save to: $DEST/templates/classic/details.personal.yml"
echo "  Profiles stored in: $DEST/generated/profiles.json"
